        ...
        return (
            <div className="card shadow-lg">
                ...
                <div className="card-body">
                    ...
                    {this.state.search?  <TrackList tracks={this.state.search_result} track={this.props.track.audioPlayer}/> : <TrackList tracks={this.state.tracks} track={this.props.track.audioPlayer}/>}
                </div>
            </div>
        )
    }
